...
func GetOutstandingCertificateRequests(relationName string) ([]RequirerCertificateRequest, error) {
	if relationName == "" {
...
func SetRelationCertificate(relationID string, providerCertificate ProviderCertificate) error {
